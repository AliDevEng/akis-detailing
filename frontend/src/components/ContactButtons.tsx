...
const WHATSAPP_MESSAGE = "Hej Mr. Aki! Jag ar intresserad av dina tjanster och vill boka en tid.";
const PHONE_NUMBER = "+46737158087";
  ...
  return (
    <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
      <a
        ...
        className="flex items-center justify-center gap-2 rounded-xl bg-green-500 py-3 text-white shadow-md transition hover:bg-green-600 hover:shadow-xl"
      >
        <WhatsAppIcon />
      ...
      <a
        ...
        className="flex items-center justify-center gap-2 rounded-xl bg-blue-600 py-3 text-white shadow-md transition hover:bg-blue-700 hover:shadow-xl"
      >
        <PhoneIcon />
        <span className="text-sm font-semibold">Ring oss</span>
      </a>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 py-3 text-white shadow-md transition hover:brightness-110 hover:shadow-xl"
      >
        <InstagramIcon />
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center justify-center gap-2 rounded-xl bg-black py-3 text-white shadow-md transition hover:bg-zinc-900 hover:shadow-xl"
      >
        <TikTokIcon />
...
function PhoneIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-5 w-5 stroke-white" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
