  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
      <a
        ...
        className="flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white py-3 rounded-xl transition shadow-md hover:shadow-xl"
      >
        <WhatsAppIcon />
      ...
      <a
        ...
        className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl transition shadow-md hover:shadow-xl"
      >
        <PhoneIcon />
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center justify-center gap-2 bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 hover:brightness-110 text-white py-3 rounded-xl transition shadow-md hover:shadow-xl"
      >
        <InstagramIcon />
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center justify-center gap-2 bg-black hover:bg-zinc-900 text-white py-3 rounded-xl transition shadow-md hover:shadow-xl"
      >
        <TikTokIcon />
...
function PhoneIcon() {
  return (
    <svg viewBox="0 0 24 24" className="w-5 h-5 stroke-white" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
