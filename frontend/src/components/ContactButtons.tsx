  ...
  const buttons: ButtonConfig[] = [
    {
      ...
      Icon: WhatsAppIcon,
      baseClass:
        "bg-[#25D366] hover:bg-[#1ebe5b] text-white shadow-[#25D366]/30",
    },
    {
      ...
      Icon: PhoneIcon,
      baseClass:
        "bg-white text-ink-950 hover:bg-zinc-100 shadow-white/20",
    },
    {
      href: INSTAGRAM_URL,
      label: "Instagram",
      sub: "Följ vårt arbete",
      Icon: InstagramIcon,
      baseClass:
        "bg-gradient-to-tr from-fuchsia-600 via-rose-500 to-amber-400 text-white shadow-rose-500/30",
    },
    {
      href: TIKTOK_URL,
      label: "TikTok",
      sub: "Se klipp från jobb",
      Icon: TikTokIcon,
      baseClass: "bg-ink-900 hover:bg-ink-800 text-white shadow-black/40",
    },
  ];
        ...
        return (
          <a
            ...
            {...(isExternal
              ...
              : {})}
            className={`group flex items-center gap-3 rounded-2xl px-4 py-3.5 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl ${btn.baseClass}`}
          >
            <span className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-black/15 transition-transform duration-500 group-hover:rotate-[10deg]">
              <btn.Icon />
            </span>
            ...
            <svg
              className="ml-auto h-4 w-4 opacity-60 transition-transform group-hover:translate-x-1 group-hover:opacity-100"
              fill="none"
              stroke="currentColor"
              strokeWidth={2.5}
              viewBox="0 0 24 24"
