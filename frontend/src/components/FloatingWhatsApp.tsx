...
function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-30 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg hover:shadow-xl flex items-center gap-2 py-3 px-4 transition transform hover:scale-105"
    >
      <svg
