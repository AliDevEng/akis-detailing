...
const WHATSAPP_MESSAGE =
  "Hej Mr. Aki! Jag ar intresserad av dina tjanster och vill boka en tid.";
...
export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-30 flex items-center gap-2 rounded-full bg-green-500 px-4 py-3 text-white shadow-lg transition hover:scale-105 hover:bg-green-600 hover:shadow-xl sm:bottom-6 sm:right-6"
    >
