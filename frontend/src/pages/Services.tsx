            ...
            <FadeInWhenVisible key={service.id} delay={index * 120}>
              <article className="grid grid-cols-1 md:grid-cols-[minmax(0,220px)_minmax(0,1fr)] gap-5 bg-slate-800/40 border border-slate-700/70 rounded-2xl shadow-md overflow-hidden">
                ...
                <div className="p-5 flex flex-col">
                  ...
                  <p className="text-sm text-slate-300 mb-3">{service.longDescription}</p>
                  ...
                  <div className="mt-4">
                    <span className="inline-block px-3 py-1 rounded-full bg-sky-600/20 border border-sky-500/30 text-sky-300 text-xs font-semibold tracking-wide">
