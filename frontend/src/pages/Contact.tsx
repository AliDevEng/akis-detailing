        ...
        <FadeInWhenVisible delay={80}>
          <section className="bg-slate-800/40 rounded-2xl border border-slate-700/60 p-6 md:p-7 shadow-lg">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
              <div>
                <h2 className="text-sm font-semibold text-slate-100 mb-1">Snabb kontakt</h2>
                <p className="text-slate-300">
                  Vi svarar snabbast via{" "}
                  <span className="text-sky-300 font-medium">WhatsApp</span> eller telefon.
                </p>
              </div>
              <div>
                <h2 className="text-sm font-semibold text-slate-100 mb-1">Område</h2>
                <p className="text-slate-300">
              ...
              <div>
                <h2 className="text-sm font-semibold text-slate-100 mb-1">Tider</h2>
                <p className="text-slate-300">
